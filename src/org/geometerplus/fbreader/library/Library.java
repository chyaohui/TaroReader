...
//		}
		...
		ZLResourceFile file = ZLResourceFile.createResourceFile("data/help/flybird.epub");
			if (file.exists()) {
				return file;
			}
		return ZLResourceFile.createResourceFile("data/help/flybird.epub");
	}
	...
	private void build() {
		System.out.println(this.getClass().getName()+"===build()==>");
